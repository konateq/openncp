...
public class TransactionTypeCell implements KpiCell {

    private final int index;

    public TransactionTypeCell(final int indexInSheet) {
    ...
    public Consumer<Cell> writeCellValue(final Transaction transaction) {
        ...
        return (cell) -> cell.setCellValue(transaction.getServiceType());
    }
}

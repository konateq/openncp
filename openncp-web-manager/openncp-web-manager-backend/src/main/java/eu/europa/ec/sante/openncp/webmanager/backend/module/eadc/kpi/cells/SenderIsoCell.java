...
public class SenderIsoCell implements KpiCell {

    private final int index;

    public SenderIsoCell(final int indexInSheet) {
    ...
    public Consumer<Cell> writeCellValue(final Transaction transaction) {
        ...
        return (cell) -> cell.setCellValue(transaction.getSndISO() != null ? transaction.getSndISO() : "");
    }
}

...
public class SenderMessageIdCell implements KpiCell {

    private final int index;

    public SenderMessageIdCell(final int indexInSheet) {
    ...
    public Consumer<Cell> writeCellValue(final Transaction transaction) {
        ...
        return (cell) -> cell.setCellValue(transaction.getSndMsgID());
    }
}

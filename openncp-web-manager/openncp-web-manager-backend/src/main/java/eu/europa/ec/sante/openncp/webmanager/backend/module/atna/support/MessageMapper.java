package eu.europa.ec.sante.openncp.webmanager.backend.module.atna.support;

import eu.europa.ec.sante.openncp.webmanager.backend.module.atna.domain.old.Message;
import eu.europa.ec.sante.openncp.webmanager.backend.module.atna.domain.old.MessageDetails;

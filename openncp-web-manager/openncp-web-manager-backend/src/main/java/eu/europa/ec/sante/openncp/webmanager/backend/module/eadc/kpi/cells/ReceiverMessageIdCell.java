...
public class ReceiverMessageIdCell implements KpiCell {

    private final int index;

    public ReceiverMessageIdCell(final int indexInSheet) {
    ...
    public Consumer<Cell> writeCellValue(final Transaction transaction) {
        ...
        return (cell) -> cell.setCellValue(transaction.getReceivingMsgID());
    }
}

...
import eu.europa.ec.sante.openncp.tools.tsam.exporter.domain.Concept;
import eu.europa.ec.sante.openncp.tools.tsam.exporter.domain.Designation;
import eu.europa.ec.sante.openncp.tools.tsam.exporter.domain.ValueSet;

package eu.europa.ec.sante.openncp.tools.tsam.sync.db.mysql;

import eu.europa.ec.sante.openncp.tools.tsam.sync.config.DataSourceProperties;
import eu.europa.ec.sante.openncp.tools.tsam.sync.db.DatabaseToolException;

...
public class RespondingGateway_ServiceStub extends Stub {
     ...
     */
    public RespondingGateway_ServiceStub(ConfigurationContext configurationContext, String targetEndpoint) throws AxisFault {
     ...
     */
    public RespondingGateway_ServiceStub(String targetEndpoint) throws AxisFault {
...
//                    to.addAttribute(att2);
    ...
    private OMElement toOM(RetrieveDocumentSetRequestType param, boolean optimizeContent) throws AxisFault {
        ...
        try {
            ...
            JaxbRIDataSource source = new JaxbRIDataSource(RetrieveDocumentSetRequestType.class,
                    param,
                    marshaller,

package eu.europa.ec.sante.openncp.security.key.selector;
...
public class X509KeySelector extends KeySelector {
    ...
    private KeySelectorResult x509DataSelect(X509Data xd, SignatureMethod sm)
        ...
        for (Object o1 : xd.getContent()) {

            // check X509Certificate
            if (o1 instanceof X509Certificate) {
                X509Certificate xcert = (X509Certificate) o1;
                ksr = certSelect(xcert, sm);
                // check X509IssuerSerial
            } else if (o1 instanceof X509IssuerSerial) {
                X509IssuerSerial xis = (X509IssuerSerial) o1;

...
public class PRPAMT201306UV02LivingSubjectDeceasedTime {
    ...
    protected List<org.hl7.v3.IVLTS> value;
    @XmlElement(required = true)
    protected org.hl7.v3.ST semanticsText;
    @XmlAttribute
     ...
     * 
     */
    public List<org.hl7.v3.IVLTS> getValue() {
        if (value == null) {
            value = new ArrayList<org.hl7.v3.IVLTS>();
        }
        return this.value;
    }
     ...
     *     
     */
    public org.hl7.v3.ST getSemanticsText() {
     ...
     *     
     */
    public void setSemanticsText(org.hl7.v3.ST value) {
